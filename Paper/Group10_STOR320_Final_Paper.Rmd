...
ggplot(data = cbbWIN_RATE, mapping = aes(x = ADJDE, y = win_rate)) + geom_point() + 
  geom_smooth(method = 'lm') + labs(title = "Relationship between Adjusted Defensive Efficiency and Win Rate ", subtitle = "Data shown is of teams in tournaments from 2013-2021.", caption = "WR: Win Rate; ADJDE: Adjusted Defensive Efficiency: Points Scored per 100 Possessions")
```
